...
//    }
    ...
    @Test
    void should_return_sort_parkingLots_when_sort_parkingLots_by_empty_space_given_parkingLot1_has_49_empty_space_and_parkingLot2_has_50_empty_space_() {

        parkingLotGroup.getParkingLots().get(0).parkingCar(new Vehicle());
        List<ParkingLot> parkingLots = parkingLotGroup.sortParkingLotsByEmptySpace();

        assertEquals(parkingLots.get(0).getEmptySpace(), 50);
